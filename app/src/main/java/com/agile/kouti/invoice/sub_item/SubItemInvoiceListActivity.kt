...
import com.agile.kouti.quotation.subItem.sub_item.QuotationSubListAdapter
...
import kotlinx.android.synthetic.main.activity_sub_item_invoice_list.*
import kotlinx.android.synthetic.main.activity_sub_item_quotation_list.*
import kotlinx.android.synthetic.main.toolbar.*
import timber.log.Timber
import java.util.ArrayList

class SubItemInvoiceListActivity : KoutiBaseActivity(), View.OnClickListener,
    SubItemClickListener {

    /*** Note : - Quotation sub item list and invoice sub item list both are same
     * so we use common adapter for sub list  */
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_sub_item_invoice_list)
        initData()
    }
    ...
    private fun initData() {
        ...
        cvAddSubInv.setOnClickListener(this)
        cvDeleteSubInv.setOnClickListener(this)
        cvSelectAllSubInv.setOnClickListener(this)
        ...
        if (intent != null) {
            ...
            swipeContainerSubInv.setOnRefreshListener {
                subItemList.clear()
                subItemListTemp.clear()
                selectedSubItemList.clear()
                subItemAdapter.notifyDataSetChanged()
                getSubListFromMainItemId()
                swipeContainerSubInv.setRefreshing(false)
            }
    ...
    private fun setSubItemAdapter() {
        val layoutManager = LinearLayoutManager(this@SubItemInvoiceListActivity, LinearLayoutManager.VERTICAL, false)
        rvSubListInv.layoutManager = layoutManager
        rvSubListInv.adapter = subItemAdapter
    }
    ...
    private fun deleteData() {
        ...
        firebaseDbClient.mainItemInvoice.child(mainItemId).child("stock_list").setValue(subItem)
        firebaseDbClient.mainItemInvoice.child(mainItemId).child("total_sub_item").setValue(totalSubCount.toString())
    ...
    override fun onSubItemClick(list: SubItemQuotation) {
        val intent = Intent(this, SubItemInvoiceDetailActivity::class.java)
